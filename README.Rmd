...
from the paper _Adversarial Sign Corrupted Isotonic Regression_.
...
1. After locally cloning the repository, you can open the `ascifit.Rproj`
project file in RStudio. This will create a separate RStudio session.

1. Once `ascifit.Rproj` is opened in RStudio, you can open the file

   ```bash
   experiments/R/paper_results/create-ascifit-plots.R
   ```

2. Select all the contents, and run the entire file. It will produce both
